...
class TestHiddenLayer:
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = HiddenLayer(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retrying_timeout_errors_doesnt_leak(self, respx_mock: MockRouter) -> None:
        ...
        with pytest.raises(APITimeoutError):
            self.client.post(
                ...
                body=cast(object, maybe_transform(dict(plaintext_name="REPLACE_ME"), SensorCreateParams)),
...
class TestAsyncHiddenLayer:
    ...
    def test_base_url_trailing_slash(self, client: AsyncHiddenLayer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHiddenLayer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHiddenLayer) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        client = AsyncHiddenLayer(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
