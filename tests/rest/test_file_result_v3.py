...
class TestFileResultV3(unittest.TestCase):
    """FileResultV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileResultV3:
        """Test FileResultV3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileResultV3`
        """
        model = FileResultV3()
        if include_optional:
            return FileResultV3(
