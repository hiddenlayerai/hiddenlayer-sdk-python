...
class TestThreadFlowLocation(unittest.TestCase):
    """ThreadFlowLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ThreadFlowLocation:
        """Test ThreadFlowLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ThreadFlowLocation`
        """
        model = ThreadFlowLocation()
        if include_optional:
    ...
    def testThreadFlowLocation(self):
        """Test ThreadFlowLocation"""
