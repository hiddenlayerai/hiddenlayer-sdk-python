...
class TestScanResultsMapV3(unittest.TestCase):
    """ScanResultsMapV3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ScanResultsMapV3:
        """Test ScanResultsMapV3
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ScanResultsMapV3`
        """
        model = ScanResultsMapV3()
        if include_optional:
            return ScanResultsMapV3(
                page = [
                    hiddenlayer.sdk.rest.models.v3_results_pagination.V3 Results Pagination(
                        self = '', 
                        first = '', 
                        prev = '', 
                        next = '', 
                ...
                items = [
                    hiddenlayer.sdk.rest.models.model_scan_v3_response.ModelScan V3 Response(
                        scan_id = '', 
                        start_time = 56, 
                        end_time = 56, 
                        status = 'done', 
