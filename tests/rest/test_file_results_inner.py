...
class TestFileResultsInner(unittest.TestCase):
    """FileResultsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FileResultsInner:
        """Test FileResultsInner
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FileResultsInner`
        """
        model = FileResultsInner()
        if include_optional:
            return FileResultsInner(
                file_instance_id = '',
                file_location = '',
